...
- Phase 0 (foundation), Phase 1 (ExamTools session/candidate ingestion), Phase 2 (Zoom + Discord event scheduling), Phase 3 (Square payment links + webhook), Phase 4 (candidate notification emails + templates), Phase 5 (FCC ULS application/license watcher), Phase 6 (payment reminder & expiration job), Phase 7 (VE tracking), and Phase 8 (VEC submission tracker) of `docs/spec.md` are implemented. Next up: Phase 9a (auth + scaffolding, first of four Phase 9 admin-backend sub-phases).
