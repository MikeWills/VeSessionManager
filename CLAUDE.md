...
- Phase 0 (foundation), Phase 1 (ExamTools session/candidate ingestion), Phase 2 (Zoom + Discord event scheduling), Phase 3 (Square payment links + webhook), Phase 4 (candidate notification emails + templates), Phase 5 (FCC ULS application/license watcher), Phase 6 (payment reminder & expiration job), and Phase 7 (VE tracking) of `docs/spec.md` are implemented. Next up: Phase 8 (ARRL submission tracker).
