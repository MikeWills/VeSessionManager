...
- Phase 0 (foundation), Phase 1 (ExamTools session/candidate ingestion), Phase 2 (Zoom + Discord event scheduling), and Phase 3 (Square payment links + webhook) of `docs/spec.md` are implemented. Next up: Phase 4 (candidate notification emails + templates).
