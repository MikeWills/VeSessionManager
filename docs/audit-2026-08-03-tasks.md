...
- [ ] **T04 — Web Production config missing `Square`/`ExamTools` sections** *(optimization B4)*
...
- [ ] **T09 — jQuery never loaded under `_PublicLayout`; client-side validation dead** *(optimization B1)*
